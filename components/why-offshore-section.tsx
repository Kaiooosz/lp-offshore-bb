...
const features = [
  {
    ...
    desc: "Organize patrimônio pessoal e riscos empresariais em estruturas jurídicas mais claras e defensáveis.",
  ...
  },
  {
    ...
    desc: "Estruture contas, recebimentos e exposição internacional com mais previsibilidade operacional.",
  ...
  },
  {
    ...
    desc: "Avalie regimes tributários favoráveis para melhorar previsibilidade, eficiência operacional e conformidade.",
  ...
  },
  {
    ...
    desc: "Use holdings, trusts ou estruturas equivalentes quando fizer sentido para sucessão e governança familiar.",
      ...
      <div className="container mx-auto px-6 max-w-7xl">
        <ScrollAnimation className="mb-20">
          <h2 className="text-4xl md:text-6xl lg:text-7xl font-light text-white tracking-tighter uppercase mb-6 leading-none max-w-4xl">
            ESTRUTURAÇÃO DEFENSÁVEL PARA UM MUNDO SEM FRONTEIRAS
          </h2>
        </ScrollAnimation>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {features.map((feature, index) => (
            <ScrollAnimation
              key={feature.title}
              className={`group relative overflow-hidden rounded-lg bg-[#0a0a0a] border border-white/5 shadow-2xl shadow-black hover:border-white/20 transition-all duration-300 ${feature.className}`}
              delay={index * 100}
            >
