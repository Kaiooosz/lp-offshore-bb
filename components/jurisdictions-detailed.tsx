...
const jurisdictions = [
    {
        ...
        features: [
            ...
            "Alta privacidade societária para operações legais.",
    ...
    },
    {
        ...
        tagline: "Ideal para quem busca proteção jurídica robusta e segregação patrimonial.",
        image: "/international-finance-documents-global-business.jpg",
        features: [
            "Minúscula ilha vulcânica no Caribe.",
            "Imposto Zero.",
            "Alto grau de privacidade societária e proteção de ativos.",
            "Registro de empresa em até 30 dias.",
    ...
    },
    {
        ...
        features: [
            ...
            "Alto grau de privacidade societária em múltiplas camadas estruturais.",
