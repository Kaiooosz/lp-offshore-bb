...
const allJurisdictions = [
    ...
    { name: "Ilhas Cayman", country: "Ilhas Cayman", status: "Patrimonial", description: "Jurisdição líder mundial para fundos de investimento e estruturas financeiras.", price: "4.999 USD", amount: 499900, priceId: "price_1TF0bIGmjEN0TRBbsJp206bd" },
    { name: "Ilhas Marshall", country: "Ilhas Marshall", status: "Operacional", description: "Popular para registro de navios e iates, com leis corporativas flexíveis e eficientes.", price: "4.999 USD", amount: 499900, priceId: "price_1TF0aNGmjEN0TRBbRYmVEYFJ" },
